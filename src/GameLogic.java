...
public class GameLogic {
			...
			public GameLogic(int gridSize, int numberOfMines){
				
				
				String line = generateLine(gridSize, numberOfMines);
			...
			public static String generateLine(int gridSize, int numberOfMines){
				...
				char [] boardVals = countString.toCharArray();
				...
				for(int i = 0; i < boardVals.length; i++){
					finalLine += boardVals[i];
				}
				
				String line = String.valueOf(gridSize) + "," + String.valueOf(gridSize) + ";" + finalLine;
